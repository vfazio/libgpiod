...
# Without the GIL providing acting as a mutex, either the C extension or the
# caller are responsible for providing thread safety.
#
# Since libgpiod is not advertised as being thread-safe, callers are ultimately
...
class InfoEvent(ThreadedTestCase):
    ...
    def test_watch_unwatch_line_info(self) -> None:
        ...
        Synchronization: Not strictly required
